...
# Other            : An excellent script to modify to drop figs, mines, etc.
#                    Could be used as part of a larger script to do more
#                    complex things.
...
# show script banner
echo "**" ANSI_3 "     --" ANSI_11 "===| " ANSI_15 "Scout v2.00" ANSI_11 " |===" ANSI_3 "--**"
