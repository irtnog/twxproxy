...
# TWX Script Pack 1: Move product script
# Author           : Xide
# Description      : Move products from one planet to another.  Can work
...
# show script banner
echo "**" ANSI_3 "     --" ANSI_11 "===| " ANSI_15 "Move Product v2.00" ANSI_11 " |===" ANSI_3 "--**"
